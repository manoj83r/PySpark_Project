...
if __name__ == "__main__":
    ...
    tCountTop100CustDF.write.saveAsTable("manoj_spark1.top_100_customer_transaction", mode="overwrite", partitionBy=None)
    ...
    sales2013NotRefunded = sales2013DF.join(refundDF, salesDF.transaction_id == refundDF.original_transaction_id,"left")
    ...
    salesMay2013NotRefunded = salesMay2013DF.join(refundDF, salesDF.transaction_id == refundDF.original_transaction_id,
                                                  "left").select(salesMay2013DF.transaction_id.alias("transaction_id1"),
                                                                 ...
                                                                 refundDF.original_transaction_id.alias("original_transaction_id2"),
    ...
    salesMay2013NotRefundedDF = salesMay2013NotRefunded.select(salesMay2013NotRefunded.transaction_id1,
                                                               ...
                                                               (year(salesMay2013NotRefunded.timestamp1)).alias("col_year"))
    custSalesMay2013DF = salesMay2013NotRefundedDF.join(customerDF, salesMay2013NotRefundedDF.customer_id1==customerDF.
                                                        customer_id,'inner').\
